# -*- coding: utf-8 -*-
"""
An implementation of the Monte Carlo Tree Search (MCTS) by NN
...
class MCTSPlayer(object):
    ...
    def __init__(self, policy_value_function, player = 1,
        ...
        if is_selfplay == 1:
            self.mcts = MCTS(self.policy_value_fn, -1, self.c_puct, self.n_playout)


    def set_player_ind(self, p):
        self.player = p
        self.mcts = MCTS(self.policy_value_fn, self.player, self.c_puct, self.n_playout)
